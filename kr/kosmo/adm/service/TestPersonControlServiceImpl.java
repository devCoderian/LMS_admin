...
public class TestPersonControlServiceImpl implements TestPersonControlService {
	...
	@Override
	public List<testPersonControlModel> std_test_f(Map<String, Object> paramMap) {

		List<testPersonControlModel> std_test_f = testPerDao.std_test_f(paramMap);
	...
	@Override
	public int cnt_std_test_f(Map<String, Object> paramMap) throws Exception {

		int cnt_std_test_f = testPerDao.cnt_std_test_f(paramMap);
		
		return cnt_std_test_f;
	}
