				...
				<!-- 메뉴 목록 끝 --> 
					...
					<div class="content">
						...
						<p class="conTitle" id="searcharea">
							<span>강의실 관리</span> 
							<span class="fr"> 
							<span><b>강 의 실 명</b>&nbsp&nbsp</span>
						...
						<div class="divLecrmList" id="divLecrmList">
							<table class="col">
								...
								<tbody id="listLecrm">
									...
									<tr>
										<td class="cursorArea">
										<a @click="LEquiplist(row.lecrm_id)"><strong>{{row.lecrm_name}}</strong></a></td>
										<td>{{row.lecrm_size}}</td>
										<td>
											<%-- <c:if test="{{row.lecrm_snum}} lt 0">  --%>
												{{row.lecrm_snum}}
											<%-- </c:if>
						...
						<tbody>
							<tr>
								...
								<td><input type="text" class="inputTxt p100"
									v-model="lecrm_name" name="lecrm_name" id="lecrm_name" /></td>
								<th scope="row">자리수</th>
