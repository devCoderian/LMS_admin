...
<script type="text/javascript">
	...
	function flist_lec(currentPage) {
		...
		callAjax("/adm/list_lec.do", "post", "text", true, param,
				resultCallback);
	}
	...
	/** 상담 목록 조회 */
	function flist_advice(currentPage, lec_id) {
		...
		callAjax("/adm/list_advice.do", "post", "text", true, param,
				resultCallback);
	}
	...
	function flist_advice_result(data, currentPage) {
		...
		var paginationHtml = getPaginationHtml(currentPage, totalCnt_adv,
				pageSize_adv, pageBlockSize, 'flist_advice', [ lec_id ]);
					...
					<table class="row" id="adv_info">
						...
						<tbody>
							<tr>
								...
								<th scope="row">학생명</th>
								<td><select name="std_id" id="list_student" class="inputTxt p100"></select> <input
							...
							<tr>
								...
								<td><input type="text" class="inputTxt p100" name="adv_plc"
									id="adv_plc" />
							</tr>
							<tr class="tr_info">
