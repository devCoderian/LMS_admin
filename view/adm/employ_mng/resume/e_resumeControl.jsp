...
<script type="text/javascript">
	...
	function first_Lec_Control( currentPage ) {
	    ...
	    callAjax("/adm/e_resumeControl_Lec_List.do", "post", "text", true, param, resultCallback);
	}
	...
	function std_List( lec_id , currentPage) {
	    ...
	    callAjax("/adm/e_resumeControl_Std_List.do", "post", "text", true, param, resultCallback);
	}
	...
	function std_List_Control( data, currentPage ) {
	    if(data.length > 50){
	       ...
	       var std_List_btn = "<br><span class='fr'> <a class='btnType gray' href='javascript:email_send_check()'><span id='searchEnter'>이메일 전송</span></a></span>";
	...
	function std_Detail( stdId ) {
	    ...
	    callAjax("/adm/e_resumeControl_std_Detail.do", "post", "text", true, param, resultCallback);
	}	
	function popupclose() {		
		gfCloseModal();
	}
	...
	function email_send_check(loginId){
	    ...
	    callAjax("/adm/e_resumeControl_Check.do", "post", "text", true, param, resultCallback1);
	}
	...
	function email_send(loginId){
	    ...
	    callAjax("/adm/e_email_send.do", "post", "json", true, param, resultCallback1);
	}	
	...
	function rs_download(rs_url) {
		...
		jQuery( "<form action='/adm/e_download.do' method='post'>" + params + "</form>").appendTo('body').submit().remove();
	}
</script>
</head>
<body>
