...
<script type="text/javascript">
	...
	function std_lec_reg(){
		...
		callAjax("/adm/std_lec_reg.do", "post", "json", true, $("#lec_reg_form")
					...
					<li class="contents">
						...
						<div class="content">
							...
							<p class="conTitle mt50">
								<span>학생 목록</span> <span class="fr"> <select id="searchKey_std"
									name="searchKey_std" style="width: 80px;">
							...
							<span class="fl"> 
							<a class="btnType3 color2" href="javascript:flist_std()"><span>전체 학생</span></a>
							<a class="btnType3 color1" href="javascript:flist_std(1,'미수강')"><span>미수강 학생</span></a>
								</span>
							<!--학생 리스트  -->
							<div class="div_list_advice" id="div_list_advice">
								<table class="col">
					...
					<table class="row">
						...
						<tbody>
							<tr>
								...
								<option value="${list.lec_id }"> ${list.lec_name}  ( ${list.c_st } ~ ${list.c_end })</option>
								</c:forEach>
								</select>
								</td>
							</tr>
