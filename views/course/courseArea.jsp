...
<body>
	...
	$(document).ready(function() {
		$.ajax({
			url:"http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey=hv1r3TuVw3a68NhJlK8NeubWiqo%2FZCS84w2lD0GVXtjtMkX%2B5qqQNbWxvviKqN7cOcYZW0lXMwgx4GK5tZSVHg%3D%3D&contentTypeId=25&pageNo="+'<%=request.getParameter("pageNo") %>'+"&areaCode="+'<%=request.getParameter("areaCode") %>'+"&MobileOS=ETC&MobileApp=AppTest",
