                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <div class="hero__caption pt-100">
                                <h1>뚜 벅 뚜 벅</h1>
                                <p>최종 발표 전까지 반드시 프로젝트 이름을 바꿔야 한다..</p>
                                <div>
                                <c:set var="item" value="2" />
                                <c:if test="${item==1 }" var="result" scope="session">
                                	<c:out value="${result }" />
                                </c:if>
                                </div>
                            </div>
                            ...
                            <form class="search-box mb-1000" name="Frm" id="Frm" onsubmit="return false">
                                <div class="input-form">
                                    <input type="text" name="search" placeholder="What are you finding?" style='position: absolute; width: 70%;'>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="/resources/assets/img/gallery/location1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="/resources/assets/img/gallery/location2.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Paris</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="/resources/assets/img/gallery/location3.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Rome</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="/resources/assets/img/gallery/location4.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Italy</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="/resources/assets/img/gallery/location5.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Nepal</p>
            ...
            <div class="container">
                ...
                <div class="directory-active">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="/resources/assets/img/gallery/properties1.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                                <div class="icon">
                                    <img src="/resources/assets/img/gallery/categori_icon1.png" alt=""> 
                                </div>
                            </div>
                            ...
                            <div class="properties__footer d-flex justify-content-between align-items-center">
                                <div class="restaurant-name">
                                    <img src="/resources/assets/img/gallery/restaurant-icon.png" alt="">
                                    <h3>Food & Restaurant</h3>
                                </div>
                                <div class="heart">
                                    <img src="/resources/assets/img/gallery/heart1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="/resources/assets/img/gallery/properties2.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="/resources/assets/img/gallery/properties3.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
            ...
            <div class="container">
                ...
                <div class="directory-active">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="/resources/assets/img/gallery/newDirectory1.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="/resources/assets/img/gallery/newDirectory2.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="/resources/assets/img/gallery/newDirectory3.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
