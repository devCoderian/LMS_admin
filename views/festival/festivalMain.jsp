...
<body>
							...
							<article class="blog_item">
								<div>
									...
									<table border=1 style="width: 100%">
										<tr>
											<td><a href="/festival/festivalArea?areaCode=1&pageNo=1"
												class="page-link">서울</a></td>
											<td><a href="/festival/festivalArea?areaCode=2&pageNo=1"
												class="page-link">인천</a></td>
											<td><a href="/festival/festivalArea?areaCode=3&pageNo=1"
												class="page-link">대전</a></td>
											<td><a href="/festival/festivalArea?areaCode=4&pageNo=1"
												class="page-link">대구</a></td>
											<td><a href="/festival/festivalArea?areaCode=5&pageNo=1"
												class="page-link">광주</a></td>
											<td><a href="/festival/festivalArea?areaCode=6&pageNo=1"
												class="page-link">부산</a></td>
											<td><a href="/festival/festivalArea?areaCode=7&pageNo=1"
												class="page-link">울산</a></td>
											<td><a href="/festival/festivalArea?areaCode=8&pageNo=1"
												class="page-link">세종</a></td>
											<td><a href="/festival/festivalArea?areaCode=31&pageNo=1"
												class="page-link">경기</a></td>
										</tr>
										<tr>
											<td><a href="/festival/festivalArea?areaCode=32&pageNo=1"
												class="page-link">강원</a></td>
											<td><a href="/festival/festivalArea?areaCode=33&pageNo=1"
												class="page-link">충북</a></td>
											<td><a href="/festival/festivalArea?areaCode=34&pageNo=1"
												class="page-link">충남</a></td>
											<td><a href="/festival/festivalArea?areaCode=35&pageNo=1"
												class="page-link">경북</a></td>
											<td><a href="/festival/festivalArea?areaCode=36&pageNo=1"
												class="page-link">경남</a></td>
											<td><a href="/festival/festivalArea?areaCode=37&pageNo=1"
												class="page-link">전북</a></td>
											<td><a href="/festival/festivalArea?areaCode=38&pageNo=1"
												class="page-link">전남</a></td>
											<td><a href="/festival/festivalArea?areaCode=39&pageNo=1"
												class="page-link">제주</a></td>
											<td><a href="/festival/festivalArea?areaCode=&pageNo=1"
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#c1').append('<h1>'+month+'월에 진행되는 축제</h1>');
			// 한자리수일 경우 0을 채워준다. 
			if(month.length == 1){ 
			  month = "0" + month; 
			} 
			...
			var  count = 1;
			// id = month01 에 들어가는 정보
			$.ajax({
				url:"http://api.visitkorea.or.kr/openapi/service/rest/KorService/searchFestival?ServiceKey="+ServiceKey
					+"&numOfRows=100&arrange=Q&MobileOS=ETC&MobileApp=AppTest&arrange=A&listYN=Y&eventStartDate="+today,
					success:function(data){				
						...
						$(data).find('item').each(function() {
							...
							if (eventstartdate > today  || count > 24) {
								
							}
							else {
								html += '<div class="col-md-5 col-lg-2 item zoom-on-hover">';
								html += '<a href="/fesDetail?writer=${member.userId}&contentid='+contentid+'&contenttypeid='+contenttypeid+'&mapx='+mapx+'&mapy='+mapy+'areacode='+areacode+'&sigungucode='+sigungucode+'&title='+encodeURIComponent(title)+'" class="lightbox" >';
			...
			$.ajax({
				url:"http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey="+ServiceKey
					+"&contentTypeId=15&cat1=A02&cat2=A0207&cat3=A02070100&numOfRows=6&pageNo=1&MobileOS=ETC&MobileApp=AppTest&areaCode=&arrange=P",
					success:function(data){				
						// API 정보 출력
						$(data).find('item').each(function() {
							var contentid = $(this).find('contentid').text();
