						...
						<div class="single-post">
							...
							<div class="blog_details">
								...
								<ul class="blog-info-link mt-3 mb-4">
									...
									<li><a href="/search/searchList?search=서울">#서울</a></li>
									<li><a href="/search/searchList?search=부산">#부산</a></li>
									<li><a href="#">#문화예술충전공간</a></li>
									<li><a href="#">#속시원한_바다</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-8 mb-5 mb-lg-0">
						<div class="blog_left_sidebar">
							<article class="blog_item">
								<div>
									<p class="excert" style="margin-bottom: 0px;">어떤 여행을 원하시나요?</p>
								</div>
								...
								<div class="blog_details">
									<a class="d-inline-block" href="blog_details.html">
										<h2 class="blog-head" style="color: #2d2d2d;">더 꾸미도록 합시다.</h2>
									</a>
									<p>글보다는 이미지를 많이 넣을 것!</p>
									<ul class="blog-info-link">
										<li><a href="#"><i class="fa fa-user"></i>혹시 몰라</a></li>
										<li><a href="#"><i class="fa fa-comments"></i>남겨 둠</a></li>
									</ul>
								</div>
							</article>
						</div>
