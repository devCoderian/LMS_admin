					...
					<div class="col-lg-4">
						<div class="blog_right_sidebar">
							...
							<aside class="single_sidebar_widget tag_cloud_widget">
								...
								<ul class="list">
									<li><a href="/travelplace/travelplaceArea?areaCode=1&pageNo=1">서울</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=2&pageNo=1">인천</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=3&pageNo=1">대전</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=4&pageNo=1">대구</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=5&pageNo=1">광주</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=6&pageNo=1">부산</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=7&pageNo=1">울산</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=8&pageNo=1">세종</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=31&pageNo=1">경기</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=32&pageNo=1">강원</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=33&pageNo=1">충북</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=34&pageNo=1">충남</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=35&pageNo=1">경북</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=36&pageNo=1">경남</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=37&pageNo=1">전북</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=38&pageNo=1">전남</a></li>
									<li><a href="/travelplace/travelplaceArea?areaCode=39&pageNo=1">제주</a></li>
								</ul>
							</aside>

							<aside class="single_sidebar_widget instagram_feeds">
								<h4 class="widget_title" style="color: #2d2d2d;">많이 검색하는 여행지</h4>
								<ul class="instagram_row flex-wrap" id="a1">
	...
	$(document).ready(function() {
		...
		$.ajax({
			url:"http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey="+ServiceKey
				...
				+"&contentTypeId=12&arrange=Q&MobileOS=ETC&MobileApp=AppTest",		
				...
				$(data).find('item').each(function() {
					...
					html += '<a href="/detail?writer=${member.userId}&contentid='+ contentid + '&contenttypeid='+ contenttypeid +'" style="color:black;"><strong>'+title +'</strong></a><br>';
					html += '<br>'+ addr1+'<br>' ;
					html += '</div></div></div>';
		...
		$.ajax({
			url:"http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?ServiceKey="+ServiceKey
				+"&areaCode="+'<%=request.getParameter("areaCode") %>'
				+"&pageNo="+'<%=request.getParameter("pageNo") %>'
				+"&contentTypeId=12&arrange=P&numOfRows=6&MobileOS=ETC&MobileApp=AppTest",		
				success:function(data){
					$(data).find('item').each(function() {
						var firstimage = $(this).find('firstimage').text();
						var firstimage2 = $(this).find('firstimage').text();
						...
						var html = '';
						html += '<li><a href="/detail?writer=${member.userId}&contentid='+ contentid + '&contenttypeid='+ contenttypeid +'" style="color:black;">';
						html += '<img class="img-fluid" src="'+firstimage+'">';
						html += '</a></li>'
